...
/// Callbacks from the XTF 2.3 dialect to the reader.
struct Xtf23Callbacks {
...
/// Parses XTF 2.3 content using SAX-like callbacks.
///
...
public:
    explicit Xtf23Dialect(Xtf23Callbacks callbacks);
    ~Xtf23Dialect();
